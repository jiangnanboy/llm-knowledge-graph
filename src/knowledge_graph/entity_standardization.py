...
def standardize_entities(triples, config):
    ...
    def normalize_text(text):
        ...
        text = text.lower()
        # Remove common stopwords that might appear in entity names，这里是删除停词的
        stopwords = {"the", "a", "an", "of", "and", "or", "in", "on", "at", "to", "for", "with", "by", "as",
                     "的", "了", "和", "是", "在", "我", "有", "你", "他", "她", "它", "这", "那",
                     "就", "也", "都", "要", "会", "可以", "能", "不", "没有", "说", "看", "听",
                     "到", "去", "来", "上", "下", "中", "里", "个", "人", "们", "我们", "你们",
                     "他们", "自己", "什么", "怎么", "为什么", "因为", "所以", "但是", "而且",
                     "如果", "然后", "一些", "这个", "那个", "这些", "那些", "啊", "哦", "嗯",
                     "吧", "呢", "吗", "呀", "啦", "给", "被", "把", "对", "很", "非常", "太",
                     "最", "更", "还", "又", "再", "已经", "正在", "将", "着", "过", "得"}
